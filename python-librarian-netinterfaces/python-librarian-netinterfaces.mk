...
PYTHON_LIBRARIAN_NETINTERFACES_VERSION = v2.0.post6
PYTHON_LIBRARIAN_NETINTERFACES_SITE = $(call github,Othernet-Project,librarian-netinterfaces,$(PYTHON_LIBRARIAN_NETINTERFACES_VERSION))
