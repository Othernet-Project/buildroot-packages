...
PYTHON_LIBRARIAN_LOGS_LICENSE = GPLv3+
PYTHON_LIBRARIAN_LOGS_LICENSE_FILES = COPYING
PYTHON_LIBRARIAN_LOGS_SETUP_TYPE = setuptools

ifeq ($(BR2_PACKAGE_PYTHON_LIBRARIAN_LOGS),y)
LIBRARIAN_COMPONENTS += librarian_logs
endif
