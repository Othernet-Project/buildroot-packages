...
PYTHON_LIBRARIAN_TWITTER_LICENSE = GPLv3+
PYTHON_LIBRARIAN_TWITTER_LICENSE_FILE = COPYING
PYTHON_LIBRARIAN_TWITTER_SETUP_TYPE = setuptools

ifeq ($(BR2_PACKAGE_PYTHON_LIBRARIAN_TWITTER),y)
LIBRARIAN_COMPONENTS += librarian_twitter
LIBRARIAN_MENU += twitter
endif
